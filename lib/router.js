...
Router.map(function() {
  ...
  this.route('report', {
    ...
    'waitOn': function() { return Meteor.subscribe('errorDetails', {'apiKey': this.params.apiKey}); },
    'data': function() { return ErrorDetails.find({ 'apiKey': this.params.apiKey }); }
  });
...
function api404 () {
  try {
    ...
    try {
      ...
      ErrorDetails.insert(errorReport);
    } catch (e) {
